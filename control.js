...
import { loadCarousel, getApi } from "./index.js";
export const loadFormLogin = () => {
  ...
  btnLogin.addEventListener("click", async () => {
    ...
    const isSuccess = await dangNhap(auth, email, password);
  ...
  btnRegister.addEventListener("click", async () => {
    const email = document.querySelector("#form3Example3").value;
    const password = document.querySelector("#form3Example4").value;
    const isSuccess = await dangKy(auth, email, password);
    if (isSuccess.isChecked) {
  ...
  if (localStorage.getItem("name")) {
    ...
    document.querySelector(
      ".headerRight"
        ...
        Info
        <ul>
          <li id="Signup"><a href="#">Đăng ký</a></li>
          <li id="Login"><a href="#">Đăng nhập</a></li>
        </ul>`;
